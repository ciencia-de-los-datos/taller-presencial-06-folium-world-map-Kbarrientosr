...
def load_affiliations():
    ...
    #no me dejo descargar el archivo desde la url, por ende me meti en el
    #repository del profe directamente, descargue el archivo y lo adjunte
    #a la carpeta de este taller
    #https://github.com/jdvelasq/datalabs/tree/master/datasets
...
def count_country_frequency(affiliations):
    ...
    #pone los elementos de una lista separados en una fila conservando el # de la fila asignada
    countries = countries.value_counts()
    #me cuenta cuantas veces aparece el pais
    return countries
